		...
		protected override float GetItemsAlignRate()
		{
			switch (Settings.AlignItems)
			{
				...
				case EasyLayoutFlexSettings.Items.End:
					return 1f;
				default:
					Debug.LogWarning(string.Format("Unknown items align: {0}", EnumHelper<EasyLayoutFlexSettings.Items>.Instance.ToString(Settings.AlignItems)));
					break;
			}
